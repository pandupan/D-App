    ...
    <div>
      <div className="sm:container px-4 sm:px-16">
        ...
        <div className="flex sm:flex-row flex-col sm:justify-between justify-start">
          ...
          <div className="flex sm:flex-row flex-col gap-8 mt-10 sm:mt-0 sm:justify-between sm:gap-x-20 sm:font-semibold sm:text-base text-sm font-medium sm:mr-16">
      ...
      <div className="border-t-[2px] border-black sm:mt-20 mt-12 container sm:w-full w-[290px] "></div>
      <div className="flex sm:flex-row flex-col sm:justify-between px-4 sm:px-12 mt-8 sm:mb-28 mb-14">
        <h3 className="text-sm hidden sm:flex">
        ...
        <h3 className="text-sm sm:hidden flex mt-8">
          © 2023 Example Company. All rights reserved.
        </h3>
      </div>
    </div>
