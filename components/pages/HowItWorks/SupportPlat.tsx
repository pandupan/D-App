...
const SupportPlat = () => {
  return(
    <div className="flex lg:flex-row flex-col-reverse md:justify-between xl:container xl:px-8 px-8 md:mt-48 xl:mb-48 gap-4 mb-28">
      ...
      <div className="flex flex-col gap-7 xl:w-[616px] xl:h-[640px] justify-center">
        <h1 className="font-black sm:text-4xl text-3xl xl:w-full sm:w-[400px]">
        Support the Platform with F-N-F Stablecoin and Get F-N-F Merchandise
        </h1>
        <p className="sm:text-lg text-sm xl:w-full sm:w-[400px]">
