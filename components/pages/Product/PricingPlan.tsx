...
const PricingPlan = () => {
  return (
    <div className="flex flex-col sm:container sm:px-0 px-4">
      ...
      <div className="flex sm:flex-row flex-col sm:justify-between sm:mt-20 mt-8">
        <div className="flex flex-col sm:justify-center sm:items-center sm:place-self-center gap-10">
          <div className="flex flex-row sm:gap-8 gap-5">
            ...
            <div className="flex flex-col my-auto gap-4">
              ...
              <p className="sm:w-[560px] sm:text-base text-sm">
        ...
        <div className="flex flex-col border-2 border-black sm:w-[616px] sm:h-[547px] h-[720px] p-8 sm:mt-0 mt-12">
