  ...
  return (
    <div className="container flex flex-col gap-10 mt-12 mb-44">
      ...
      <div className="flex justify-start">
        <div className="mt-8 grid grid-cols-1 grid-rows-1 md:grid-cols-2 md:grid-rows-2 xl:grid-cols-3 xl:grid-rows-2 gap-20">
          <div>
          ...
          <button className="outline outline-offset-2 outline-1 w-3/4  sm:w-[768px] h-[48px]"> Explore Opportunities</button>
          </div>
        </div>
        <div>
        </div>
