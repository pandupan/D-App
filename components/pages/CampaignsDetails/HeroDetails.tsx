...
const HeroDetails = () => {
  return (
    <div className="flex justify-start w-full sm:h-[497px] h-[424px]">
              ...
              <div className=' my-[110px] sm:w-full w-[335px] sm:h-full h-[224px] sm:container absolute sm:px-0 px-4 flex flex-col text-white sm:gap-8 gap-4'>
                <div className='font-semibold sm:text-base text-sm'>Empower</div>
                <h1 className='sm:text-5xl text-3xl font-black '>Supporting Local Initiatives</h1>
                <p className='sm:w-[680px] w-[300px] sm:h-full h-[72px] sm:text-base text-sm'>Join us in empowering local communities by supporting micro-crowdfunded campaigns in your zip code.</p>
