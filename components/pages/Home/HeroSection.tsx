...
const HeroSection = () => {
  return (
    <div className="w-full sm:min-h-screen flex flex-col">
      <h1 className="sm:text-6xl text-4xl font-bold text-center mt-[225px] px-10 mx-2">Join the F-N-F Dapp revolution today!</h1>
      <p className=" sm:text-xl text-center sm:mt-[80px] mt-[20px] text-sm px-10 mx-2">Experience the power of decentralized micro-crowdfunding and earn exclusive F-N-F NFTs.</p>
